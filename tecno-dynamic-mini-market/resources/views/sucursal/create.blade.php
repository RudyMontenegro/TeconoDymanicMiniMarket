...
<div class="card shadow">
    ...
    <form action="{{url('/sucursal/registrarSucursal')}}" class="form" id="newValidate" method="post"
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control  {{$errors->has('nombre')?'is-invalid':'' }}" name="nombre"
                        ...
                        onBlur="comprobarSucursal()" onkeyup="validarNombre()"><span id="estadoSucursal"></span>
        ...
        <div class="col-md-11 mx-auto ">
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control  {{$errors->has('responsable')?'is-invalid':'' }}"
                        name="responsable" id="responsable"
                        value="{{ isset($sucursal->responsable)?$sucursal->responsable:old('responsable') }}"
                        onkeyup="validarResponsable()"><span id="estadoResponsable"></span>
