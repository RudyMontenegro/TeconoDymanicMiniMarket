                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('/producto/categoria/editar/'.$categorias->id)}}"
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModal2{{$categorias->id}}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form method="post" id="idFormDelCat"
                                                        action="{{url('/producto/categoria/'.$categorias->id)}}"
