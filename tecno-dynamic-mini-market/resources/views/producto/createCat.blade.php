...
<form action="{{url('/producto/registrarCategoria')}}" class="form" id="newValidate" method="post" enctype="multipart/form-data">
    ...
    <div class="col-6">
        ...
        value="{{ isset($sucursal->nombre)?$sucursal->nombre:old('nombre')  }}" onBlur="comprobarCategoria()" onkeyup="validarNombre()"
    ...
    <div class="col-6">
        ...
        value="{{ isset($sucursal->descripcion)?$sucursal->descripcion:old('descripcion') }}" onkeyup="validardescripcion()"
