    ...
    <div class="card-body">
        ...
        <form action="{{ url('proveedor/'.$proveedor->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nombre_contacto" class="form-control" value="{{ old('nombre_contacto',$proveedor->nombre_contacto)}}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="telefono" class="form-control" type="tel" value="{{ old('telefono',$proveedor->telefono)}}" required>
            </div>
            <div class="form-group">
                <label for="email">email</label>
                <input type="text" name="email" class="form-control" type="email"  value="{{ old('email',$proveedor->email)}}" required>
            </div>
            <div class="form-group">
                <label for="web_site">Sitio web</label>
                <input type="text" name="web_site" class="form-control" type="url" value="{{ old('web_site',$proveedor->web_site)}}" >
            </div>
            <div class="form-group">
                <label for="categoria">Categoria</label>
                <input type="text" name="categoria" class="form-control" value="{{ old('categoria',$proveedor->categoria)}}" >
            </div>
